                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('customer.store') }}" id="myForm"
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">IDH NO </label>
                                    <div class="form-group col-sm-10">
                                        <input name="idh" class="form-control" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
        ...
        $(document).ready(function() {
            $('#myForm').validate({
                ...
                messages: {
                    ...
                    area: {
                        required: 'Please Enter Your area Number',
                    },
                    idh: {
                        required: 'Please Enter Your idh',
                    },
                },
                errorElement: 'span',
