                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('trx.detail', $item['product2']['VendorBatch']) }}"
                                                    class="btn btn-success sm" title="Detail Trx"> <i class="fas fa-eyes"></i>
                                                    Detail </a>
                                                <a href="{{ route('trx.edit', $item->id) }}"
                                                    class="btn btn-info sm" title="Edit Trx"> <i class="fas fa-edit"></i>
                                                    Edit </a>
